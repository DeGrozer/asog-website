            ...
            <div class="reveal">
                ...
                <div class="relative rounded-lg overflow-hidden mb-5" style="height:420px;">
                    ...
                    <div class="absolute bottom-4 left-4 right-4 md:right-auto md:max-w-[320px] z-10 bg-gold rounded-lg p-4 md:p-5 shadow-lg">
                        ...
                        <div class="flex items-start gap-2 mb-2">
                            ...
                            <span class="text-[.78rem] text-black/80 font-normal leading-snug"><?= esc($contactAddr) ?></span>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <a href="mailto:<?= esc($contactEmail) ?>" class="text-[.78rem] text-black/80 font-medium no-underline hover:text-black transition-colors"><?= esc($contactEmail) ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-1">
                    ...
                    <a href="<?= esc($fbUrl) ?>" target="_blank" rel="noopener" title="Facebook"
                        class="inline-flex items-center justify-center w-9 h-9 no-underline transition-all duration-200 hover:text-[#1877F2] hover:-translate-y-0.5" style="color:rgba(2,13,24,.4)">
                    ...
                    <a href="<?= esc($igUrl) ?>" target="_blank" rel="noopener" title="Instagram"
                        class="inline-flex items-center justify-center w-9 h-9 no-underline transition-all duration-200 hover:text-[#E4405F] hover:-translate-y-0.5" style="color:rgba(2,13,24,.4)">
                    ...
                    <a href="<?= esc($xUrl) ?>" target="_blank" rel="noopener" title="X"
                        class="inline-flex items-center justify-center w-9 h-9 no-underline transition-all duration-200 hover:text-black hover:-translate-y-0.5" style="color:rgba(2,13,24,.4)">
                    ...
                    <a href="<?= esc($threadsUrl) ?>" target="_blank" rel="noopener" title="Threads"
                        class="inline-flex items-center justify-center w-9 h-9 no-underline transition-all duration-200 hover:text-[#101010] hover:-translate-y-0.5" style="color:rgba(2,13,24,.4)">
