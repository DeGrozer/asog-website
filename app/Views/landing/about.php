    ...
    <div class="grid grid-cols-1 lg:grid-cols-[280px_1px_1fr] gap-8 lg:gap-14 items-start relative z-[1]">
        ...
        <div class="reveal reveal-d2">
            ...
            <div class="flex flex-wrap gap-1.5 mt-7 reveal-group">
                ...
                <span
                    class="rc text-[.57rem] font-semibold tracking-[.1em] uppercase text-navy/50 border border-navy/[.12] bg-navy/[.04] px-3 py-1 rounded-sm transition-colors duration-200 cursor-default hover:border-gold hover:text-gold hover:bg-gold/[.06]"><?= esc(trim($tag)) ?></span>
                <?php endforeach; ?>
            </div>
            <a href="<?= site_url('about') ?>"
                class="group inline-flex items-center gap-1.5 mt-8 text-[.65rem] font-bold tracking-[.13em] uppercase text-navy no-underline transition-all duration-200 hover:text-gold hover:gap-3">
