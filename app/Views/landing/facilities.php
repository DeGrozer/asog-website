...
<section id="facilities" class="relative overflow-hidden bg-off py-16 md:py-24 px-6 md:px-10 lg:px-14">
    ...
    <div class="max-w-[1200px] mx-auto relative z-[2]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 reveal-group">
            <div
                class="rc rounded-lg border border-dark/[.06] overflow-hidden bg-white shadow-sm shadow-dark/[.04] transition-all duration-300 hover:shadow-md hover:shadow-dark/[.08]">
            ...
            <div
                ...
                <div class="p-5 md:p-7">
                    <h3 class="font-display text-[1.1rem] text-dark mb-2">FabLab</h3>
            ...
            <div
                ...
                <div class="p-5 md:p-7">
                    <h3 class="font-display text-[1.1rem] text-dark mb-2">Co-Working Space</h3>
                    <p class="text-[.8rem] font-light leading-[1.75] text-dark/40">Lorem ipsum dolor sit amet,
                        consectetur adipiscing elit. Ut enim ad minim veniam quis nostrud.</p>
                </div>
            </div>
            <div
                ...
                <div class="p-5 md:p-7">
                    <h3 class="font-display text-[1.1rem] text-dark mb-2">Conference Room</h3>
                    <p class="text-[.8rem] font-light leading-[1.75] text-dark/40">Lorem ipsum dolor sit amet,
                        consectetur adipiscing elit. Ut enim ad minim veniam quis nostrud.</p>
                </div>
            </div>
