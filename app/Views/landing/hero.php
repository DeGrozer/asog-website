...
<section id="hero" class="relative w-full h-screen min-h-[680px] overflow-hidden" data-navhint="dark">
    ...
    <div class="hero-overlay absolute inset-0 z-[2]" style="background:
    ...
    <div class="hero-content absolute bottom-0 left-0 z-[3] px-8 md:px-14 lg:px-20 pb-2 md:pb-12 w-full max-w-[960px]">
        ...
        <!-- Gold accent rule -->
        <div class="hero-kicker flex items-center gap-3 mb-6">
        ...
        <div class="hero-actions flex flex-col gap-1">
            ...
            <!-- Dots — below the CTA -->
            <div class="hero-dots flex items-center gap-2.5">
