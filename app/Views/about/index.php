        ...
        <div class="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-8 lg:gap-12">
            ...
            <div class="min-w-0">
                <div class="max-w-[760px] text-[.95rem] font-normal leading-[1.72] text-left" style="color:#020d18">
                    ...
                    <!-- ── OUR STORY ── -->
                    <h2 id="our-story"
                        class="font-display text-[1.8rem] md:text-[2.2rem] leading-[1.18] text-dark mb-4 scroll-mt-28">
                        Our Story</h2>

                    <p id="who-we-are"
                        class="mb-2 text-[.78rem] font-semibold tracking-wide uppercase text-gold/80 scroll-mt-28">
                        Who
                        We Are</p>
                    <p class="mb-2.5">
                    ...
                    <ul class="space-y-2 list-none pl-0 mb-3">
                        ...
                        <li class="flex gap-3 items-start"><span
                                ...
                                capitalists, and government agencies</span></li>
                        <li class="flex gap-3 items-start"><span
                                class="text-gold text-lg leading-none mt-1">•</span><span><strong
                    ...
                    <div class="h-px bg-dark/[.08] my-7"></div>
                    ...
                    <p id="why-asog"
                        class="mb-2 text-[.78rem] font-semibold tracking-wide uppercase text-gold/80 scroll-mt-28">Why
                        ASOG?</p>
                    <p class="mb-2.5">
                    ...
                    <p id="who-can-join"
                        ...
                        Who
                        Can Join?</p>
                    <p class="mb-2.5">We support a diverse group of innovators, researchers, and entrepreneurs, including:
                    </p>
                    ...
                    <ul class="space-y-2 list-none pl-0">
                        <li class="flex gap-3 items-start"><span
                                ...
                                food production,
                                processing, and distribution using AI-driven solutions</span></li>
                        <li class="flex gap-3 items-start"><span
                                class="text-gold text-lg leading-none mt-1">•</span><span>Increasing profitability and
                                efficiency for MSMEs</span></li>
                        <li class="flex gap-3 items-start"><span
                                class="text-gold text-lg leading-none mt-1">•</span><span>Strengthening the regional
                                startup ecosystem through strategic partnerships</span></li>
                        <li class="flex gap-3 items-start"><span
                                class="text-gold text-lg leading-none mt-1">•</span><span>Creating
                                employment
                                opportunities and promoting inclusive economic growth</span></li>
                    </ul>
