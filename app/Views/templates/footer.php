        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pt-12 md:pt-16 pb-8 md:pb-10 border-b border-white/[.06]">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex gap-2">
                    <!-- Facebook -->
                    <a href="#" target="_blank" rel="noopener" title="Facebook" class="w-7 h-7 rounded-full bg-white/[.05] flex items-center justify-center no-underline transition-all duration-200 hover:bg-gold/15 group">
                    ...
                    <!-- Instagram -->
                    <a href="#" target="_blank" rel="noopener" title="Instagram" class="w-7 h-7 rounded-full bg-white/[.05] flex items-center justify-center no-underline transition-all duration-200 hover:bg-gold/15 group">
                    ...
                    <!-- X -->
                    <a href="#" target="_blank" rel="noopener" title="X" class="w-7 h-7 rounded-full bg-white/[.05] flex items-center justify-center no-underline transition-all duration-200 hover:bg-gold/15 group">
                    ...
                    <!-- Threads -->
                    <a href="#" target="_blank" rel="noopener" title="Threads" class="w-7 h-7 rounded-full bg-white/[.05] flex items-center justify-center no-underline transition-all duration-200 hover:bg-gold/15 group">
